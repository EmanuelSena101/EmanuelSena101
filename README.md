# </> Data Engineer | Python | SQL | ETL | Data Pipelines | Cloud (GCP/AWS)

Data Engineer focused on building pipelines and data platforms for distributed batch and streaming processing.

I work transforming raw data into reliable, structured datasets that support analytics, automation, and machine learning applications. My work involves developing ingestion pipelines, transforming data in distributed environments, and orchestrating data workflows at scale.

I have experience building data pipelines and environments that combine Data Lakes and Data Warehouses to support analytical workloads and modern data pipelines.

Special interest in modern data architectures, distributed processing, and building scalable data platforms.
